      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Or{" "}
            <Link to="/register" className="font-medium text-starbucks-green hover:text-starbucks-darkGreen">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-sm font-medium text-starbucks-green hover:text-starbucks-darkGreen"
                  >
                    Forgot password?
                  </Link>
                </div>
